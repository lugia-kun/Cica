...
getfont IBM_Plex-1.1.6 .zip \
        https://github.com/IBM/plex/releases/download/v1.1.6/TrueType.zip \
        IBM_Plex-1.1.6
...
for weight in Regular Italic Bold BoldItalic; do
    cp IBM_Plex-1.1.6/TrueType/IBM-Plex-Mono/IBMPlexMono-$weight.ttf .
done
